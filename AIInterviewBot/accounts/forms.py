...
class LoginForm(forms.Form):
  ...
  username = forms.CharField(
      label="帳號",
      widget=forms.TextInput(attrs={
          'class': 'form-control login-label',
          'style': 'width: 100%;'
      }))
  ...
  remember_me = forms.BooleanField(label="保持登入",
                                   required=False,
...
TYPE_CHOICES = (('', '請選擇問題類型'), ('A', '帳號問題'), ('T', '技術問題'), ('O', '其他問題'))
  ...
  class Meta:
    ...
    widgets = {
        ...
        forms.Textarea(
            attrs={
                'class': 'form-control',
                'placeholder': '遇到問題了嗎?若無法在幫助中心找到相關的解決方式，請在此簡單敘述您遇到的問題。',
